...
class GoogleSheetsClient:
    ...
    def append_expense(self, expense_data: dict, image_url: str = None) -> None:
        row = (
            [datetime.now().strftime("%d/%m/%Y %H:%M:%S")]
            + [expense_data.get(field) for field in EXPENSE_FIELDS]
...
if __name__ == "__main__":
    ...
    sheets_client.append_expense(test_data, None)
